...
@include('layouts.header')
 ...
 <div class="slider-area">
    <div class="hero-slider owl-carousel">
        ...
        <!--Single Slider End-->
        <!--Single Slider Start-->
        <div class="single-slider" style="background-image: url('{{ asset('assets/img/slider/2.jpg') }} )">   
            <div class="hero-slider-content">
                <h1>Education Needs <br> Complete Solution</h1>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque unde, at molestias voluptatem praesentium quia magnam? Iste aliquam, voluptas sapiente animi, repudiandae officiis voluptatem tempore alias nihil. Aperiam voluptatum, velit.</p>
                <div class="slider-btn">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-item">
                    <div class="single-item-image overlay-effect">
                        <a href="courses-details.html"><img src="{{ asset('assets/img/course/1.jpg') }}" alt=""></a>
                        <div class="courses-hover-info">
                            <div class="courses-hover-action">
                                <div class="courses-hover-thumb">
                                    <img src="{{ asset('assets/img/teacher/1.png')}}" alt="small images">
                                </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-item">
                    <div class="single-item-image overlay-effect">
                        <a href="courses-details.html"><img src="{{ asset('assets/img/course/2.jpg')}}" alt=""></a>
                        <div class="courses-hover-info">
                            <div class="courses-hover-action">
                                <div class="courses-hover-thumb">
                                    <img src="{{ asset('assets/img/teacher/1.png')}}" alt="small images">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-item">
                    <div class="single-item-image overlay-effect">
                        <a href="courses-details.html"><img src="{{ asset('assets/img/course/3.jpg')}}" alt=""></a>
                        <div class="courses-hover-info">
                            <div class="courses-hover-action">
                                <div class="courses-hover-thumb">
                                    <img src="{{ asset('assets/img/teacher/1.png')}}" alt="small images">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-latest-item">
                    <div class="single-latest-image">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/latest/1.jpg')}}" alt=""></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-latest-item">
                    <div class="single-latest-image">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/latest/2.jpg')}}" alt=""></a>
                    </div>
                    <div class="single-latest-text">
                        <h3><a href="blog-details.html">Learn English in ease</a></h3>
                        <div class="single-item-comment-view">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-latest-item">
                    <div class="single-latest-image">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/latest/4.jpg')}}" alt=""></a>
                    </div>
                    <div class="single-latest-text">
                        <h3><a href="blog-details.html">Learn English in ease</a></h3>
                        <div class="single-item-comment-view">
                ...
                <div class="single-product mb-30">
                    <div class="product-img img-full">
                        <a href="single-product.html" tabindex="0">
                            <img src="{{ asset('assets/img/product/16.jpg')}}" alt="">
                        </a>
        ...
        <div class="row">
            <div class="testimonial-slider owl-carousel">
                ...
                <div class="col-12">
                    ...
                    <div class="single-testimonial-area">
                        <div class="testimonial-image">
                            <img src="{{ asset('assets/img/testimonial/testimonial2.png')}}" alt="">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-12">
                    ...
                    <div class="single-testimonial-area">
                        <div class="testimonial-image">
                            <img src="{{ asset('assets/img/testimonial/testimonial3.png')}}" alt="">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-12">
                    ...
                    <div class="single-testimonial-area">
                        <div class="testimonial-image">
                            <img src="{{ asset('assets/img/testimonial/testimonial4.png')}}" alt="">
                        </div>
                        <div class="testimonial-content">
                            <p class="author-desc">  All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you ! ..</p>
                ...
                <div class="col-12">
                    ...
                    <div class="single-testimonial-area">
                        <div class="testimonial-image">
                            <img src="{{ asset('assets/img/testimonial/testimonial5.png')}}" alt="">
                        </div>
                        <div class="testimonial-content">
                            <p class="author-desc">  All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you ! ..</p>
